...
<head>
    ...
    <!-- Title -->
    <title>@lang('419 Error - IsabiPay Escrow')</title>
    <!-- Favicon -->
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-6">
                    <div class="error-wrap text-center">
                         <br>                        <br>                        <br>        <br> 
                        <h2 class="error-wrap__title">@lang('419 Error Occour')</h2>
                        <br>
                        <p class="error-wrap__desc">@lang('An error occur, please try again')</p>
                        <a href="{{route('home')}}" class="btn btn--base">@lang('Try again')</a>
                    </div>
                </div>
            </div>
        </div>
