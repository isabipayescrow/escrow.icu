                                ...
                                <div class="contactus-form">
                                    ...
                                    <form action="" method="post" autocomplete="off">
                                        ...
                                        <div class="row gy-md-4 gy-3">
                                            ...
                                            <div class="col-sm-6">
                                                <label for="title" required>@lang('Name')</label>
                                                <input type="text" class="form--control" name="title" id="title" placeholder="@lang('Enter Name')">
                                            </div>
                                            <div class="col-sm-6">
                                                @if($type==1)
                                           ...
                                           <br>
                                              <br>
                                           @if($type==1)
                                                <label for="email">@lang('Buyer\'s Wallet Address')</label>
                                                @else
                                                <label for="email">@lang('Seller\'s Wallet Address')</label>
                                                @endif
                                                
                                           <br>
                                        <input type="text" class="form--control" name="" id="email" placeholder="@lang('Enter Address')">
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <label for="charge_pay" required>@lang('Who Will Pay Fee')</label>
                                        ...
                                        <div class="col-sm-12">
                                            <label for="details">@lang('More Details')</label>
                                            <textarea name="details" class="form--control" id="" cols="30" rows="10" placeholder="@lang('Write aggreement details ...')"></textarea>
                                        </div>
                                            <div class="col-sm-12">
                                                <button class=" btn btn--base w-100"> @lang('Create Escrow')</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
